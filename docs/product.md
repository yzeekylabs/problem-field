...
Help someone turn a messy body of calls, transcripts, notes, screenshots, and recordings into a legible problem field—without flattening the evidence, mistaking mention count for signal, or outsourcing judgment to an AI summary.

## The Field Loop

The product teaches six recursive moves:

1. **Orient** — name what needs to be understood and why it matters now.
2. **Forage** — bring in source material and preserve exact evidence with provenance.
3. **Cluster** — arrange recurrence and difference without forcing a conclusion.
4. **Frame** — name possible interpretations across evidence.
5. **Test** — seek contradiction, alternatives, segment differences, and missing context.
6. **Decide** — continue, narrow, challenge, pivot, or archive; then state the next inquiry.
...
After 20 minutes with real material, a user should be able to say:

> I can see the shape of the problem, what supports it, what challenges it, and what I should investigate next.

## Explicit non-goals for this slice

- A feature-complete FigJam or Miro replacement.
- Automatic research synthesis presented as truth.
- Hosted collaboration, permissions, or sync.
- A provider-specific conversation store inside the domain model.
- A single numeric score that claims to measure qualitative confidence.
